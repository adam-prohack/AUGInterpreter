...
class BooleanStringComparsionOperation(AST.BooleanExpressionBase):
    def __init__(self, left_expression : AST.StringExpressionBase, operator : str, right_expression : AST.StringExpressionBase):
